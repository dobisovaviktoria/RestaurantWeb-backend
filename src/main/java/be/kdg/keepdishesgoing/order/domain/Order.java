...
public class Order {
    ...
    private Order(
            ...
            @JsonProperty("placedAt") LocalDateTime placedAt,
            @JsonProperty("acceptedAt") LocalDateTime acceptedAt,
            @JsonProperty("readyAt") LocalDateTime readyAt,
        ...
        this.orderLines = new ArrayList<>(orderLines != null ? orderLines : List.of());
    ...
    private void apply(DomainEvent event) {
        ...
        } else if (event instanceof OrderReadyForPickupEvent e) {
            this.status = OrderStatus.READY_FOR_PICKUP;
            this.readyAt = e.readyAt();
